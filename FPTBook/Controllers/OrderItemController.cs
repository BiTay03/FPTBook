...
namespace FPTBook.Controllers
{
    public class OrderItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Quantity,Price,OrderId,OrderDate,BookId")] OrderItem orderItem)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Book, "Id", "Id", orderItem.BookId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Quantity,Price,OrderId,OrderDate,BookId")] OrderItem orderItem)
        {
            if (id != orderItem.Id)
            {
                return NotFound();
